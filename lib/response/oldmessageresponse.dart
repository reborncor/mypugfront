...
class OldMessageResponse extends BasicResponse {
  ...
  OldMessageResponse({code, message, payload})
      : super(code: code, message: message, payload: payload);

  OldMessageResponse.jsonData(
      {required this.oldmessages, code, message, payload})
      : super(code: code, message: message, payload: payload);
  ...
  factory OldMessageResponse.fromJsonData(Map<String, dynamic> json) {
    return OldMessageResponse.jsonData(
      ...
      oldmessages: (json['payload']['oldmessages'] as List)
