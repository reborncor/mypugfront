...
class UserPugResponse extends BasicResponse {
  ...
  UserPugResponse({code, message, payload})
      : super(code: code, message: message, payload: payload);

  UserPugResponse.jsonData(
      {code, message, payload, required this.username, required this.pugs})
      : super(code: code, message: message, payload: payload);
  ...
  factory UserPugResponse.fromJsonData(Map<String, dynamic> json) {
    return UserPugResponse.jsonData(
      ...
      pugs: (json['payload']['pugs'] as List)
          .map((e) => PugModel.fromJsonData(e))
          .toList(),
    );
  }
