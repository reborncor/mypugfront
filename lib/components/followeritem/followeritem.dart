  ...
  Widget build(BuildContext context) {
    ...
    return Consumer<ThemeModel>(builder: (context, ThemeModel notifier, child) {
      ...
      return InkWell(
        ...
        child: ListTile(leading: const Image(image: AssetImage("asset/images/user.png"),width: 40, height: 40,), title: Text(widget.username, style: TextStyle(color:  this.notfier.isDark ? Colors.white : Colors.black),),
            trailing: OutlinedButton(child: Text(text, style: const TextStyle(color: Colors.white)), onPressed:() async {
