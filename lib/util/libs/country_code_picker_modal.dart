...
/// {@endtemplate}
class CustomCountryCodePickerModal extends StatefulWidget {
  /// {@macro country_code_picker_modal}
  const CustomCountryCodePickerModal({
    Key? key,
  ...
  @override
  State<CustomCountryCodePickerModal> createState() =>
      _CustomCountryCodePickerModalState();
}

class _CustomCountryCodePickerModalState
    extends State<CustomCountryCodePickerModal> {
